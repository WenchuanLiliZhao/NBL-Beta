...
export default function Content() {
  ...
  return (<>
    <Layout ep={EPInfo}>
      ...
      <p><TS time={0.1}>Lorem ipsum dolor sit amet,</TS> <TS time={1.9}>consectetur adipiscing elit.</TS> <TS>Donec porttitor felis a diam molestie faucibus.</TS> Aliquam et tempor felis. In ac facilisis lectus, a eleifend sapien. Phasellus aliquam sapien a pretium cursus. Suspendisse ac elementum lacus, sit amet mollis augue. Aliquam arcu mauris, scelerisque et dictum non, elementum in mauris. Sed vulputate ut lectus in mollis. Sed scelerisque nulla vel ante maximus mollis. Donec vel erat quis tellus rhoncus varius ut vel dolor. Proin id leo erat. Duis congue vestibulum fermentum.</p>
